...
CC=gcc -std=gnu99
CXX=g++
CFLAGS=-c -O3 -g -I . -I/opt/libvpx-realtime/include -I libwebm -I libyuv/include -g -D_FORTIFY_SOURCE=2
LDFLAGS=
LIBS=-pthread -lm -lc -ludt /opt/libvpx-realtime/lib/$(ARCH)/libvpx.a
...
all:  vpxtestbench
	mkdir -p debian/tmp
	cp vpxtestbench debian/tmp

vpxtestbench: $(OBJECTS_FULL)
